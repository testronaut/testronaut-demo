...
class RecipeMother {
  private _recipePictures = [
    {
      keyword: 'beer',
      pictureUri: 'https://shop.ninkasi.fr/259-large_default/ninkasi-french-ipa-75cl.jpg',
    },
    {
      keyword: 'burger',
      pictureUri: 'https://www.ninkasi.fr/wp-content/uploads/2022/06/header_burger.jpg',
    },
    {
      keyword: 'salad',
      pictureUri: 'https://www.ninkasi.fr/wp-content/uploads/2022/10/lyonnaise.png',
    },
  ];
